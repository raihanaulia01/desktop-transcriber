...
parser.add_argument("--vad-threshold", type=restricted_float, default=0.45, help="Silero VAD speech probability sensitivity threshold between 0.0 and 1.0 (default: 0.45).")
